...
module.exports = class Crawler {
    ...
    async getCourseForDownload (page, url, { all }) {
        ...
        logger.log('go to school:', school.href) //https://codewithmosh.com/p/nextjs-projects-issue-tracker
        ...
        while (nextButton) {
            ...
            const paginationExists = await page.$('nav.pagination') !== null//.hcaptcha-box
            logger.log('pagination exist', paginationExists)
            if (paginationExists) {
                ...
                logger.debug('next button not available:', nextButton)
                nextButton = false
            }
